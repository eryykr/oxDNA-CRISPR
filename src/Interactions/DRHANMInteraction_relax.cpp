...
DRHANMInteraction_relax::DRHANMInteraction_relax(bool btp) :
				DRHANMInteraction(false) {
	OX_LOG(Logger::LOG_INFO, "Using unphysical backbone (DRHANM_relax interaction)");
	_constant_force = 0;
	_harmonic_force = 1;
}
...
number DRHANMInteraction_relax::_backbone(BaseParticle *p, BaseParticle *q, bool compute_r, bool update_forces) {
